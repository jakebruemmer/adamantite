...
require 'view/screen/copy_screen'
require 'view/screen/login_screen'
require 'view/screen/set_master_password_screen'
require 'view/screen/show_screen'
require 'view/screen/update_master_password_screen'
require 'view/form/license_form'
require 'view/form/password_object_form_window'
